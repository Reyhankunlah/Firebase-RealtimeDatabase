...
//
//     final tablePremierModel = tablePremierModelFromJson(jsonString);

import 'dart:convert';

TablePremierModel tablePremierModelFromJson(String str) =>
    TablePremierModel.fromJson(json.decode(str));

String tablePremierModelToJson(TablePremierModel data) =>
    json.encode(data.toJson());

class TablePremierModel {
  List<Table> table;

  TablePremierModel({required this.table});

  factory TablePremierModel.fromJson(Map<String, dynamic> json) =>
      TablePremierModel(
